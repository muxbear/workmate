...
BUILTIN_TOOLS: list[dict] = [
    {
        "name": "execute_code",
        "display_name": "代码执行",
        "description": "执行 Python 代码并返回标准输出与错误信息。注意：当前在后端本机进程内执行，请仅对可信智能体启用。",
        "category": "code",
        "version": "1.4.0",
        "tags": ["python", "code"],
        "params": [
            {"key": "code", "label": "代码", "required": True, "type": "string"},
            {"key": "language", "label": "编程语言", "required": False, "type": "string", "default": "python"},
            {"key": "timeout", "label": "超时(s)", "required": False, "type": "number", "default": 30},
        ],
    },
    {
        "name": "shell_command",
        "display_name": "Shell 命令",
        "description": "执行系统命令并返回标准输出与错误信息。注意：当前在后端本机进程内执行（非沙箱），请仅对可信智能体启用。",
        "category": "code",
        "version": "1.2.0",
        "tags": ["shell", "cli"],
        "params": [
